...
| 3 | Outcome realized | Did the completed task produce the intended business result (resolved case, approved claim, accepted code change)? |
| 4 | Value captured | Was the outcome converted into measurable business value (revenue, cost avoided, time saved, risk reduced)? |

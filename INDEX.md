...
- [The Three Hidden Cost Multipliers](02-cost-economics/hidden-multipliers.md)
...
- [Maturity Model](08-maturity-model/maturity-levels.md)

## 09-sector-specific-finops

- [Sector Guidance: Claims / Document Processing](09-sector-specific-finops/claims-processing.md)
- [Sector Guidance: Coding / Engineering Agents](09-sector-specific-finops/coding-agents.md)
- [Sector Guidance: Customer Support Agents](09-sector-specific-finops/customer-support-agents.md)
- [Sector Guidance: Document Processing / RAG Workflows](09-sector-specific-finops/document-processing-rag.md)

## 10-case-studies

- [Case Study Template](10-case-studies/case-study-template.md)
- [Case Study: Tier-1 Customer Support Agent](10-case-studies/customer-support-agent.md)

## 11-implementation-playbooks

- [Playbook: Architecture Economic Review](11-implementation-playbooks/architecture-review-playbook.md)
- [Playbook: 90-Day AI FinOps Adoption Plan](11-implementation-playbooks/finops-adoption-90-day-plan.md)
- [Playbook: Cost Spike Incident Response](11-implementation-playbooks/incident-cost-spike-response.md)

...
3. For changes to core methodology (`01-foundations/` through `08-maturity-model/`), open an issue first, since these sections anchor the templates and playbooks, so changes should be deliberate.

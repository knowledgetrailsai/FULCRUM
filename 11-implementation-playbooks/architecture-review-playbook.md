...
1. Walk the workload routing decision tree ([Workload Routing](../05-architecture-and-design/workload-routing.md)) — for each major step, confirm why it needs a model at all, and at what tier.
...
Both the architecture/engineering lead and FinOps lead sign the checklist. Unresolved items get an owner and a date — the review does not close with open items unassigned.

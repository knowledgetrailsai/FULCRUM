...
This repo is one of ten in the knowledgetrailsai OASIS ecosystem: OASIS, Ageis, Forge, Loom, Helm, Verity, Compass. When you add a cross-repo link, use the exact repository name and default branch — they are not uniform:

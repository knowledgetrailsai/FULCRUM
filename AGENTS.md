...
Fulcrum is the economics, FinOps and sustainability companion implementing OASIS Chapter 22.
...
This repo is one of ten in the knowledgetrailsai OASIS ecosystem: OASIS, Ageis, Forge, Loom, Helm, Verity, Compass. When you add a cross-repo link, use the exact repository name and default branch, since they are not uniform:
